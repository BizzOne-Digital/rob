      ...
      <div className="mx-auto max-w-[1200px] px-5 sm:px-8 lg:px-10">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 font-serif text-3xl text-[#2f2a26] sm:text-4xl">
              What We Create
            </h2>
          </div>
          <Link
            href="/what-we-create"
            className="hidden text-[13px] font-semibold text-[#8f7665] underline-offset-4 hover:underline sm:inline"
          >
            View all
          </Link>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-2 p-3 sm:p-4">
                  ...
                  <span className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/90 text-[#6B5B5B] transition group-hover:bg-[#a68d7b] group-hover:text-white">

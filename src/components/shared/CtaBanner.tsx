...
export function CtaBanner({
  ...
  return (
    <section className={cn("py-16 md:py-24", className)}>
      <Container>
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-powder-blue via-icy-blue to-dusty-lavender/50 px-8 py-14 text-center grain-panel md:px-16 md:py-20">

...
/** Birth month flower options — two choices per month, January through December */
...
Transform your space with natural fragrance — one melt at a time.`,
    ...
    images: [
      img("/images/products/Soy-Wax-Melts-champagne-rose.png", "Soy wax melts — Champagne Rose"),
      img("/images/products/Soy-Wax-Melts-strawberry-swirl.png", "Soy wax melts — Strawberry Swirl"),
    ],
...
Transform your space with natural fragrance — one melt at a time.`,
    ...
    images: [
      img("/images/products/Soy-Wax-Melts-strawberry-swirl%20(2).png", "1 oz soy wax melt — Strawberry Swirl"),
      img("/images/products/Soy-Wax-Melts-fresh-pear%20(2).png", "1 oz soy wax melt — Fresh Pear"),
    ],
...
Personalization is available! Add a name to make your keychain extra special. Please note: Personalized designs may have slightly smaller flower and font sizes to ensure a clean, balanced engraving.`,
    ...
    images: [
      img("/images/products/Engraved-Birth-Month-Flower-Keychain-july-1.png", "Engraved birth month flower keychain — July Larkspur"),
      img("/images/products/Engraved-Birth-Month-Flower-Keychain-july-2.png", "Engraved birth month flower keychain — July Water Lily"),
    ],
    optionDefinitions: [
